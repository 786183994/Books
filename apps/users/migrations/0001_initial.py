    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='image/touxiang.png', upload_to='image/%Y/%m')),
                ('identity_id', models.CharField(max_length=18, verbose_name='\u8eab\u4efd\u8bc1\u53f7')),
                ('author_number', models.CharField(blank=True, max_length=15, null=True, verbose_name='\u4f5c\u8005\u7f16\u53f7')),
